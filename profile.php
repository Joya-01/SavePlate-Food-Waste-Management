...
<!--             
            ...
            <br> -->
              ...
              <!-- <p style="color: #004AAD;">username</p> -->
              <br>
              ...
              <a href="logout.php" style="float: left;margin-top: 6px ;border-radius:5px; background-color: #004AAD; color: white;padding: ;padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
